...
export const EDUCATION_COSTS = {
  ...
  university: {
    ...
    // 授業料（年額）+ 入学金を4年で按分
    national: 535800 + Math.round(282000 / 4), // 国立：授業料535,800 + 入学金282,000/4 = 606,300
    public: 536382 + Math.round(391305 / 4), // 公立：授業料536,382 + 入学金391,305/4 ≒ 634,208
    'private-arts': 815069 + Math.round(225651 / 4), // 私立文系：授業料815,069 + 入学金225,651/4 ≒ 871,481
    'private-science': 1136074 + Math.round(251029 / 4), // 私立理系：授業料1,136,074 + 入学金251,029/4 ≒ 1,198,831
  },
} as const;
